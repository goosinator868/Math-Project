...
public final class Driver {
        ...
        while (!isFinished) {
            ...
            switch (choice) {
                ...
                case 6: //ENCODER DECODER-----------------------------
                    ...
                    break;
                case 7:
                    System.out.println("\n1) Shorten matrix output length\n"
                            + "2) Output full matrix double length\n"
                            + "3) Go back");

                    int choice5 = getIntInput(1, 3);

                    switch (choice5) {
                        case 1:
                            System.out.println("Output will be short.");
                            shorten = true;
                            break;
                        case 2:
                            System.out.println("Output will be full length.");
                            shorten = false;
                            break;
                        case 3:
                            break;
    ...
    private static void doLUDecomp() {
        ...
        try {
            ...
            System.out.println("L Matrix:\n" + LU[0].toString(shorten));
            System.out.println("U Matrix:\n" + LU[1].toString(shorten));
    ...
    private static void doHouseHolder() {
        ...
        try {
            ...
            System.out.println("Q Matrix:\n" + QR[0].toString(shorten));
            System.out.println("R Matrix:\n" + QR[1].toString(shorten));
    ...
    private static void gaussSeidelEncode() {
        try {
            ...
            System.out.println("Encoded stream: (0.0 = 00, 1.0 = 01, 11.0 = 11"
                    + ", 10.0 = 10)\n"
                    + Arrays.toString(y));
    ...
    private static void doPowerMethod() {
        System.out.println("Input name of file containing the"
                            + " Matrix to calculate.");
        System.out.println("**Note: The file must be in the"
                + " same directory as the Driver.class file**");
    ...
    private static void doGaussSeidelSolve() {
        System.out.println("Input name of file containing"
        ...
        try {
            ...
            Matrix Ab = parser(path);

            double[] b = Ab.getColumn(Ab.getColumns() - 1);
            Matrix A = new Matrix(Ab.getRows(),
                    Ab.getColumns() - 1);
    ...
    private static void doJacobiSolve() {
        System.out.println("Input name of file containing"
                + "the augmented Matrix to decompose.");
        System.out.println("**Note: The file must be in the"
                + " same directory as the Driver.class file"
    ...
    private static void doQRSolve() {
        ...
        try {
            ...
            double[] solution = MatrixMath.solve_qr_b(QR[0],
                    QR[1], b);
    ...
    private static void doLUSolve() {
        ...
        try {
            ...
            double[] solution = MatrixMath.solve_lu_b(LU[0], LU[1], b);
    ...
    private static double[] vectorParser(int size) {
        ...
        while (current < size) {
            try {
                System.out.println("Input " + (size - current) + " number(s),"
                        + " divided by spaces.");
...
//        return v;
    ...
    private static double[] xGenerator(int n) {
